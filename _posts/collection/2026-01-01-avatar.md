...
<div style="margin-bottom: 20px;">
  <a href="https://app.getcollectr.com/showcase/profile/be47c36e-c7ad-4dc2-8192-29739ac66463?collection=12180bd7-f04f-416b-b2f1-51357d99fe7c" target="_blank" class="sheets-link" style="background-color: #8b5cf6; margin-right: 10px;">View Avatar on Collectr</a>
...
<img src="{{ '/assets/images/themes/avatar.jpg' | relative_url }}" alt="Avatar: The Last Airbender Collection" class="set-hero-image">

<div id="collection-overview-avatar">
  <p>Loading collection overview...</p>
</div>

<div id="set-detail-avatar">
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load overview stats
    const overviewContainer = document.getElementById('collection-overview-avatar');
    if (overviewContainer) {
      Promise.all([
        ...
        for (let i = 1; i < invData.length; i++) {
          if (invData[i][invSetIndex] === 'Avatar') {
        ...
        for (let i = 1; i < valData.length; i++) {
          if (valData[i][valSetIndex] === 'Avatar') {
        ...
        overviewContainer.innerHTML = `
          <div class="collection-overview">
            <div class="overview-title">Avatar Collection Overview</div>
    ...
    const detailContainer = document.getElementById('set-detail-avatar');
    if (detailContainer) {
      loadSetDetail(inventoryUrl, 'set-detail-avatar', 'Avatar');
    }
  });
</script>
